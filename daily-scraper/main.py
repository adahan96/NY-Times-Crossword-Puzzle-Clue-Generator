...
app = Flask(__name__)
# Flask required for Google Cloud Run
@app.route("/")
def scrape_puzzle():
    ...
    # Upload json to cloud database
    client = pymongo.MongoClient("mongodb+srv://emre:r9fPG2T2TK42VR5f@cluster0-kbe7a.mongodb.net/test?retryWrites=true&w=majority")
    db = client['ny-puzzle']
